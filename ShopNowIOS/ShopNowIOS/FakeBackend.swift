    ...
    func fetchProducts() async throws -> [Product] {
        ...
        let base = [
            Product(
                ...
                price: "€89.00",
                description: "Lightweight neon green sneakers with great comfort.",
                imageName: "shoes1"
            ),
            Product(
                id: "2",
                name: "Red Sneakers",
                price: "€89.00",
                description: "Lightweight red sneakers with great comfort.",
                imageName: "shoes2"
            ),
            Product(
                id: "3",
                name: "Black T-Shirt",
                price: "€19.00",
                description: "Soft and premium T-Shirt made from unicorn hair.",
                imageName: "t_shirt"
            ),
            Product(
                id: "4",
                name: "Navy Shirt",
                price: "€199.00",
                description: "Probably a navy shirt.",
                imageName: "shirt"
            )
        ]
